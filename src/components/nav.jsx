...
function Navbar() {
  ...
  return (
    ...
    >
      {/* Logo */}
      <a href="#home-page" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "10px" }}>
        {/* Moon icon */}
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
          <path d="M19 13.5A8.5 8.5 0 1 1 8.5 3a6.5 6.5 0 0 0 10.5 10.5z"
        ...
        <span style={{
          ...
          Adwaitha Krishna<span style={{ color: "var(--text-mid)", fontWeight: 400 }}></span>
        </span>
      </a>
      ...
      <a
        ...
        onMouseEnter={(e) => { e.target.style.boxShadow = "0 0 30px rgba(232,160,32,0.6), 0 4px 24px rgba(0,0,0,0.5)"; e.target.style.transform = "translateY(-1px)"; }}
        onMouseLeave={(e) => { e.target.style.boxShadow = "0 0 20px rgba(232,160,32,0.35), 0 4px 16px rgba(0,0,0,0.4)"; e.target.style.transform = "translateY(0)"; }}
      >
        Hire Me
      </a>
    </nav>
