...
function Contact() {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ maxWidth: "1280px", width: "100%", position: "relative", zIndex: 1 }}
      >
        {/* Label */}
        ...
        >
          Feel free to reach out for collaborations, projects, internships, or just
        ...
        >
          {contacts.map(({ title, value, link, icon, label, glow }) => (
            <a
              key={title}
              href={link}
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.borderColor = "rgba(232,160,32,0.32)";
              }}
              onMouseLeave={(e) => {
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(8,22,32,0.95), rgba(12,30,44,0.9))",
        ...
        >
          ...
          <div style={{ position: "relative", zIndex: 1 }}>
            ...
            <p style={{ fontFamily: "var(--font-body)", fontSize: "1rem", color: "var(--text-dim)" }}>
          ...
          <a
            ...
            style={{
              ...
              textDecoration: "none",
              borderRadius: "100px",
              boxShadow: "0 0 28px rgba(232,160,32,0.5), 0 4px 24px rgba(0,0,0,0.5)",
            ...
            onMouseEnter={(e) => {
              ...
              e.target.style.boxShadow = "0 0 44px rgba(232,160,32,0.7)";
            }}
            onMouseLeave={(e) => {
              e.target.style.transform = "translateY(0)";
              e.target.style.boxShadow = "0 0 28px rgba(232,160,32,0.5), 0 4px 24px rgba(0,0,0,0.5)";
            }}
          >
            Send a Message →
          </a>
